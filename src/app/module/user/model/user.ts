export class User {
    ...
    public static firstNamePattern = "^[a-zA-Z]{2,29}$";
    public static lastNamePattern = "^[a-zA-Z]{2}[a-zA-Z ]{0,27}$";
    public static pseudoPattern = "^[a-zA-Z]{2,29}$";
    public static emailPattern = "^[a-zA-Z0-9._-]{2,}@[a-z0-9._-]{2,}.[a-z]{2,4}$";
    public static passwordPattern = "^[a-zA-z0-9]{8,29}$";
